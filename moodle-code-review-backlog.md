...
blockers and immediate cleanup warnings were addressed. No automated-test failures or Moodle PHPCS warnings remain in the
verified Moodle 4.5 Docker checkout.
...
3. Review the broad local `README.md` edits for release wording and maintainer voice. The Moodle 4.5/5.0 support statement now matches `version.php`.
