...
8. [DONE] Extracted post-grade-update synchronization
   ...
   Verification: Local PHP syntax passes. Moodle 5.1 PHPCS, PHPUnit, and Behat remain to be run in a Moodle 5.1 checkout.

9. [DONE] Reviewed support documentation warning
   Location: `README.md`; `version.php`
   Evidence: README now states that the working tree declares Moodle 5.1 support and points Moodle 4.5/5.0 users to `MOODLE_405_STABLE`.
...
- Behat: PASS after Moodle cache purge on the Moodle 4.5 branch application. Moodle 5.1 branch runtime checks remain required.
...
- Moodle 5.1 runtime check, because no local Moodle 5.1 container was available in the current workspace permissions.
